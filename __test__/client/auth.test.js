...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Andy.Rippin13',
      password: 'LGbWheVAOTY7q8L',
      email: 'Jaeden_Lemke8@hotmail.com',
      name: 'Laura Bruen',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 32,
      mobileNo: '(829) 124-1403',
      loginOTP: {},
      resetPasswordLink: {},
      loginRetryLimit: 738,
      loginReactiveTime: '2023-12-01T13:17:32.449Z',
      id: '654a889de60a52297f9e5d77'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Elisabeth_Bartoletti27',
        'password':'cloK8fUfY5mzsGZ',
        'email':'Savanna92@yahoo.com',
        'name':'Tracy Mayer',
        'shippingAddress':[{
          '_id':false,
          'pincode':'navigating',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/client/auth/forgot-password')
      .send({ 'email':'Savanna92@yahoo.com', });
