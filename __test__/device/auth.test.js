...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Randi36',
      password: 'nXXosD0Lvhqol7i',
      email: 'Adrianna_Langworth79@yahoo.com',
      name: 'Miss Zachary Carroll',
      shippingAddress: [
        {
          _id: false,
          pincode: 'navigate',
      ...
      userType: 12,
      mobileNo: '(942) 258-2642',
      loginOTP: {},
      resetPasswordLink: {},
      loginRetryLimit: 830,
      loginReactiveTime: '2024-10-24T00:04:08.757Z',
      id: '654a889de60a52297f9e5d05'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Turner.Nader24',
        'password':'v8DYD6ibjvVqU8s',
        'email':'Forrest63@gmail.com',
        'name':'Shane Kirlin V',
        'shippingAddress':[{
          '_id':false,
          'pincode':'sensor',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Forrest63@gmail.com', });
