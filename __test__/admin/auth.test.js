...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Hipolito_Lemke76',
      password: 'l0cLx0OM2YjfMjp',
      email: 'Retta70@hotmail.com',
      name: 'Salvador Boyer',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 560,
      mobileNo: '(590) 807-7394',
      loginOTP: {},
      resetPasswordLink: {},
      loginRetryLimit: 254,
      loginReactiveTime: '2024-01-01T07:07:24.481Z',
      id: '654a889de60a52297f9e5c93'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Kaitlin_Macejkovic',
        'password':'sZfZV0FWaB3_bqU',
        'email':'Mireille.Pacocha57@hotmail.com',
        'name':'Randall Ondricka',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Quetzal',
          'address1':'convergence',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Mireille.Pacocha57@hotmail.com', });
